...
use crate::context_menu::{MenuCancel, MenuConfirm, MenuNext, MenuPrev};
...
pub(crate) fn commands() -> Vec<Command> {
    ...
    let mut v = vec![
        ...
        cmd(Category::General, "Check for updates", &[], CheckForUpdates, None, true),
        ...
        cmd(Category::Navigation, "New tab", &["secondary-n"], NewTab, ws_modal, true),
        cmd(Category::Navigation, "Close tab", &["secondary-w"], CloseTab, ws_modal, true),
        cmd(Category::Navigation, "Next tab", &["ctrl-tab"], NextTab, ws_modal, true),
        cmd(Category::Navigation, "Previous tab", &["ctrl-shift-tab"], PrevTab, ws_modal, true),
        cmd(Category::Navigation, "Go to tab 1", &["secondary-1"], ActivateTab(1), ws_modal, false),
        cmd(Category::Navigation, "Go to tab 2", &["secondary-2"], ActivateTab(2), ws_modal, false),
        cmd(Category::Navigation, "Go to tab 3", &["secondary-3"], ActivateTab(3), ws_modal, false),
        cmd(Category::Navigation, "Go to tab 4", &["secondary-4"], ActivateTab(4), ws_modal, false),
        cmd(Category::Navigation, "Go to tab 5", &["secondary-5"], ActivateTab(5), ws_modal, false),
        cmd(Category::Navigation, "Go to tab 6", &["secondary-6"], ActivateTab(6), ws_modal, false),
        cmd(Category::Navigation, "Go to tab 7", &["secondary-7"], ActivateTab(7), ws_modal, false),
        cmd(Category::Navigation, "Go to tab 8", &["secondary-8"], ActivateTab(8), ws_modal, false),
        cmd(Category::Navigation, "Go to last tab", &["secondary-9"], ActivateTab(9), ws_modal, false),
        ...
        cmd(Category::View, "Toggle sync panel", &["secondary-y"], ToggleSync, ws_modal, true),
        ...
        // Every menu renders through `ContextMenu`, so these cover all of them.
        cmd(Category::Dialogs, "Next menu item", &["down", "ctrl-n"], MenuNext, Some("Menu"), false),
        cmd(Category::Dialogs, "Previous menu item", &["up", "ctrl-p"], MenuPrev, Some("Menu"), false),
        cmd(Category::Dialogs, "Run menu item", &["enter"], MenuConfirm, Some("Menu"), false),
        cmd(Category::Dialogs, "Close menu", &["escape"], MenuCancel, Some("Menu"), false),
    ];
