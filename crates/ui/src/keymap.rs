...
pub(crate) fn commands() -> Vec<Command> {
    ...
    let mut v = vec![
        ...
        cmd(Category::Navigation, "Go to tab 1", &["secondary-1"], ActivateTab1, ws_modal, false),
        cmd(Category::Navigation, "Go to tab 2", &["secondary-2"], ActivateTab2, ws_modal, false),
        cmd(Category::Navigation, "Go to tab 3", &["secondary-3"], ActivateTab3, ws_modal, false),
        cmd(Category::Navigation, "Go to tab 4", &["secondary-4"], ActivateTab4, ws_modal, false),
        cmd(Category::Navigation, "Go to tab 5", &["secondary-5"], ActivateTab5, ws_modal, false),
        cmd(Category::Navigation, "Go to tab 6", &["secondary-6"], ActivateTab6, ws_modal, false),
        cmd(Category::Navigation, "Go to tab 7", &["secondary-7"], ActivateTab7, ws_modal, false),
        cmd(Category::Navigation, "Go to tab 8", &["secondary-8"], ActivateTab8, ws_modal, false),
        cmd(Category::Navigation, "Go to last tab", &["secondary-9"], ActivateTab9, ws_modal, false),
