    ...
    fn download_setting(&self, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        setting_block(
            ...
            h_flex()
                ...
                .child(Button::new("choose-dir", "Choose…", ButtonStyle::Soft).size(ControlSize::Small).on_click(
            ...
            v_flex()
                ...
                .child(
                    h_flex()
                        ...
                        .child(Button::new("clear-rclone-cache", "Clear", ButtonStyle::Soft).size(ControlSize::Small).on_click(
    ...
    fn rclone_path_row(
        ...
        if let Some(input) = editing {
            return h_flex()
                ...
                .child(Button::new(browse_id, "Browse", ButtonStyle::Soft).size(ControlSize::Small).on_click(cx.listener(|this, _: &ClickEvent, _, cx| this.browse_rclone_edit(cx))))
                .child(Button::new(cancel_id, "Cancel", ButtonStyle::Secondary).size(ControlSize::Small).on_click(cx.listener(|this, _: &ClickEvent, _, cx| this.cancel_rclone_edit(cx))))
        ...
        h_flex()
            ...
            .child(
                h_flex()
                    .gap_1()
                    .child(Button::new(change_id, "Change", ButtonStyle::Soft).size(ControlSize::Small).on_click(
        ...
        v_flex()
            ...
            .child(
                h_flex()
                    ...
                    .child(Button::new("clean-up", "Clean up", ButtonStyle::Soft).size(ControlSize::Small).on_click(
