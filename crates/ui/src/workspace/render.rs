...
impl Render for Workspace {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        if self.modal.is_some() || self.prompt.is_some() || self.menu_owns_focus() {
        ...
        v_flex()
            ...
            .on_action(cx.listener(Self::action_uninstall))
            ...
            .on_action(cx.listener(|this, a: &ActivateTab, w, cx| this.jump_to_tab(a.0, w, cx)))
            ...
            .children(self.render_active_menu(cx))
